...
int main() {
  ...
  struct node *z;
  while (1) {
    printf("1. Insertion of sensor data into the network\t2. Deletion\n");
    printf("3. Traverse\t4. Search\t5. Exit");
    printf("\nEnter your choice:");
    scanf("%d", &ch);
    switch (ch) {
      case 1:
        ...
        printf("Sensor data %d inserted into the network\n",data);
        break;
      case 2:
        printf("Enter the element to delete:");
	    scanf("%d", &key);
	    red_black_delete(tree_search(key));
	    printf("Sensor data %d deleted\n",key);
        break;
      case 3:
        tree_print(ROOT);
        printf("\n");
